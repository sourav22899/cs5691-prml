...
plt.title(r'Grayscale image of the given picture')
...
plt.title(r'Reconstructed image using top 10% principal components')
plt.show()       # Plotting the grayscale picture with N=10%

error1 = np.subtract(gray,q1)
plt.imshow(error1, cmap=plt.get_cmap('gray'))
plt.title(r'Error image using top 10% principal components')
...
plt.title(r'Reconstructed image using top 25% principal components')
plt.show()        # Plotting the grayscale picture with N=25%

error2=np.subtract(gray,q2)
plt.imshow(error2, cmap=plt.get_cmap('gray'))
plt.title(r'Error image using top 25% principal components')
...
plt.title(r'Reconstructed image using top 50% principal components')
plt.show()      # Plotting the grayscale picture with N=50%

error3=np.subtract(gray,q3)
plt.imshow(error3, cmap=plt.get_cmap('gray'))
plt.title(r'Error image using top 50% principal components')
...
plt.title(r'Reconstructed image using random 10% principal components')
...
plt.title(r'Error image using random 10% principal components')
...
plt.plot(arr,reconstruction_error5,'red')
plt.title(r'Reconstruction Error Vs N (where N goes form 10% to 100%)')
plt.xlabel(r'Top N% principal components are taken -->')
